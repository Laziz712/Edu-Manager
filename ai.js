...
async function askAI({ message, history = [], context = {} }) {
  ...
  const systemPrompt =
    ...
    `Javoblaringni juda uzun qilma — 350-400 so'zdan oshirma.`;
  ...
  try {
    const response = await ai.models.generateContent({
      ...
      config: {
        ...
        thinkingConfig: {
          thinkingLevel: 'LOW', // oddiy suhbat uchun chuqur fikrlash shart emas — javob to'liq chiqishi uchun kamaytirildi
        },
      }
    });
